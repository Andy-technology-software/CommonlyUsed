...
- (void)setupViewControllers {
    UIViewController *imViewController = [[IMViewController alloc] init];
    UIViewController *imNavigationController = [[UINavigationController alloc]
                                                initWithRootViewController:imViewController];
    ...
    [tabBarController setViewControllers:@[imNavigationController,firstNavigationController, secondNavigationController,indexNavigationController]];
